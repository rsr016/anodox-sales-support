  ...
  <div class="mx-6">
    ...
    <ul role="list" class="divide-y divide-gray-300">
      <li class="flex justify-between gap-x-6 py-5" v-for="c in clients">
        ...
        <div class="sm:flex sm:flex-col sm:items-center gap-y-6 shrink-0">
          <p class="my-auto text-gray-900"><NuxtTime :datetime="c.created_at" year="numeric" month="long" day="numeric" /></p>
          <p class="justify-between mt-auto pt-3 text-gray-500 self-end"><NuxtLink class="btn-light" :to="`/simula/${c.id}`">Simulação</NuxtLink> <NuxtLink class="btn-light" :to="`/simula/${c.id}`">Relatório</NuxtLink></p>
        </div>
      </li>
    </ul>
